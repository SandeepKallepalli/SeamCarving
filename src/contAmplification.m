clear all
close all
colorImage=imresize(imread('../images/tower_small.jpg'),1.2);
% colorImage=imread('../images/tower_small.jpg');
[sizex,sizey,sizez]=size(colorImage);
countx=0.2/1.2*sizex;
county=0.2/1.2*sizey;
...
colorImage=permute(colorImage,[2,1,3]);
imwrite(colorImage,'../OutputImages/towersmall1.jpg');
figure
subplot(2,1,1)
